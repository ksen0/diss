...
\node(S13)[style = bubble, text width=4cm] at ($(S1.north)!{(1-1/3)}!(S1.south)$) {Understandable, Usable, Extensible Code};
...
% text nodes
\node(R1)[text centered, text width = 4cm, anchor = south] at ($(B1.north -| T1.west) - (0.7,0)$) {Adoption / Adaption of tools / skills};
