...
\tikzstyle{circlestyle}=[fill=white, draw=black, circle, text centered, line width=1mm]
...
%
\node(P2)[style=boxstyle, text width=4cm] at (2,-5.0) 
{ modeling\\ computer simulation\\ numerical approx.\\ differential equations };
...
\node(K31)[style = circlestyle, text width = 0.4cm] at ($(K3.west) - (0.5,0)$) {};

\node(K4)[text width = 4cm] at ($(3,\keyOffset-2)$) {optional code work};
\node(K41)[style = circlestyledash, text width = 0.4cm] at ($(K4.west) - (0.5,0)$) {};
